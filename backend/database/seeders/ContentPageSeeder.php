...
class ContentPageSeeder extends Seeder
{
        ...
        foreach (ContentPage::allowedSlugs() as $slug) {
            foreach (['en', 'ar'] as $locale) {
                ContentPage::query()->updateOrCreate(
                    ...
                    [
                        'payload' => $this->payloadFor($slug, $locale),
                        'published_at' => $now,
                    ],
                );
            }
    ...
    private function payloadFor(string $slug, string $locale): array
    {
        return match ($locale) {
            'ar' => match ($slug) {
                'landing-page' => $this->landingAr(),
                'about-page' => $this->aboutAr(),
                'admissions-page' => $this->admissionsAr(),
                'contact-page' => $this->contactAr(),
                default => [],
            },
            default => match ($slug) {
                'landing-page' => $this->landingEn(),
                'about-page' => $this->aboutEn(),
                'admissions-page' => $this->admissionsEn(),
                'contact-page' => $this->contactEn(),
                default => [],
            },
        };
    }
     ...
     * @return array<string, mixed>
     */
    private function landingEn(): array
    {
        return [
            'hero' => [
     ...
     * @return array<string, mixed>
     */
    private function landingAr(): array
    {
        return [
            'hero' => [
     ...
     * @return array<string, mixed>
     */
    private function aboutAr(): array
    {
        return [
     ...
     * @return array<string, mixed>
     */
    private function admissionsEn(): array
    {
        return [
     ...
     * @return array<string, mixed>
     */
    private function admissionsAr(): array
    {
        return [
     ...
     * @return array<string, mixed>
     */
    private function contactAr(): array
    {
        return [
            'title' => 'تواصل معنا',
